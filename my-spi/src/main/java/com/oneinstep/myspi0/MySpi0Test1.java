...
public class MySpi0Test1 {
    ...
    public static void main(String[] args) {
        ...
        // 获取 zookeeper 注册中心
        RegistryFactory zkRegistryFactory = extensionLoader.getExtension("zookeeper");
        // 将服务注册到 zookeeper 注册中心
        Registry zkRegistry = zkRegistryFactory.getRegistry(zkUrl);
        zkRegistry.register(serviceUrl);
        System.out.println(extensionLoader.getExtensionInstances());

        URL nacosUrl = new URL("nacos", "127.0.0.1", 8848, "", null);
        // 获取 nacos 注册中心
        RegistryFactory nacosRegistryFactory = extensionLoader.getExtension("nacos");
        Registry nacosRegistry = nacosRegistryFactory.getRegistry(nacosUrl);
        // 将服务注册到 nacos 注册中心
